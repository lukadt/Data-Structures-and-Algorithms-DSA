// <copyright file="CommonTree.cs" company="Data Structures and Algorithms">
//   Copyright (C) Data Structures and Algorithms Team.
// </copyright>
// <summary>
//   Base type for all tree's that conform to a basic standard. Ex: AVL, BST.
// </summary>
using System;
...
{
    /// <summary>
    /// Base type for common tree's. 
    /// </summary>
    /// <remarks>
    /// <para>
    /// A common tree is something that can be navigated using comparison logic. Ex: AVL, BST etc.
    /// </para>
    /// <para>
    /// The nodes that make up what is deemed a <see cref="CommonTree{TNode,TValue}"/> must adhere by the contract
    /// defined in <see cref="ICommonTreeNode{TNode,TValue}"/>.
    /// </para>
    /// </remarks>
        ...
        where TValue : IComparable<TValue>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonTree{TNode,TValue}"/> class.
        /// </summary>
        public CommonTree()
        {
        ...
        /// <summary>
        /// Gets the root of the <see cref="CommonTree{TNode,TValue}"/>.
        /// </summary>
        public TNode Root
        {
            get { return m_root; }
        ...
        /// <summary>
        /// Traverses the items in the <see cref="CommonTree{TNode,TValue}"/> in breadth first order.
        /// </summary>
        /// <remarks>
        /// This method is an O(n) operation where n is the number of nodes in the <see cref="CommonTree{TNode,TValue}"/> .
        /// </remarks>
        /// <returns>
        /// An <see cref="IEnumerator{T}" /> that can be used to iterate through the <see cref="CommonTree{TNode,TValue}"/>.
        /// </returns>
        ...
        /// <summary>
        /// Traverses the <see cref="CommonTree{TNode,TValue}"/> in an in order traversal.
        /// </summary>
        /// <remarks>
        /// This method is an O(n) operation where n is the number of nodes in the <see cref="CommonTree{TNode,TValue}"/>.
        /// </remarks>
        ...
        /// <summary>
        /// Traverses the <see cref="CommonTree{TNode,TValue}"/> in a postorder fashion.
        /// </summary>
        /// <remarks>
        /// This method is an O(n) operation where n is the number of nodes in the <see cref="CommonTree{TNode,TValue}"/> .
        /// </remarks>
        ...
        /// <summary>
        /// <para>
        /// An <see cref="IEnumerator{T}"/> that iterates through the <see cref="CommonTree{TNode,TValue}"/>.  
        /// </para>
        /// <para>
        /// The default is preorder traversal of the items in the <see cref="CommonTree{TNode,TValue}"/>.
        /// </para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Finds the largest value in the <see cref="CommonTree{TNode,TValue}"/>.
        /// </summary>
        /// <returns>Largest value in the <see cref="CommonTree{TNode,TValue}"/>.</returns>
        /// <exception cref="InvalidOperationException">
        /// The <see cref="CommonTree{TNode,TValue}"/> contains <strong>0</strong> items.
        /// </exception>
        ...
        /// <summary>
        /// Finds smallest value in the <see cref="CommonTree{TNode,TValue}"/>.
        /// </summary>
        /// <returns>Smallest value in the <see cref="CommonTree{TNode,TValue}"/>.</returns>
        /// <exception cref="InvalidOperationException">
        /// The <see cref="CommonTree{TNode,TValue}"/> contains <strong>0</strong> items.
        /// </exception>
        ...
        /// <summary>
        /// Finds a node in the <see cref="CommonTree{TNode,TValue}"/> with the specified value.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an item is contained within the <see cref="CommonTree{TNode,TValue}"/>.
        /// </summary>
        /// <param name="item">Item to search the <see cref="CommonTree{TNode,TValue}"/> for.</param>
        /// <returns>
        /// True if the item is contained within the <see cref="CommonTree{TNode,TValue}"/>; otherwise false.
        /// </returns>
        ...
        /// </remarks>
        /// <returns>
        /// A one-dimensional <see cref="Array"/> containing the items of the <see cref="CommonTree{TNode,TValue}"/>.
        /// </returns>
        ...
        /// <summary>
        /// Traverse the <see cref="CommonTree{TNode,TValue}"/> in breadth first order, i.e. each node is visited on 
        /// the same depth to depth n, where n is the depth of the tree.
        /// </summary>
        /// <param name="root">The root node of the <see cref="CommonTree{TNode,TValue}"/>.</param>
        /// <returns>
        ...
        /// <summary>
        /// Traverses the <see cref="CommonTree{TNode,TValue}"/> in an in order fashion, i.e. returning the values of the 
        /// nodes when a node is passed underneath.
        /// </summary>
        /// <param name="root">The root node of the <see cref="CommonTree{TNode,TValue}"/>.</param>
        ...
        /// Finds the largest value in the <see cref="CommonTree{TNode,TValue}"/>.
        /// </summary>
        /// <param name="root">Root node of the <see cref="CommonTree{TNode,TValue}"/>.</param>
        /// <returns>Largest value in the <see cref="CommonTree{TNode,TValue}"/>.</returns>
        ...
        /// <summary>
        /// Finds the smallest value in the <see cref="CommonTree{TNode,TValue}"/>.
        /// </summary>
        /// <param name="root">Root node of the <see cref="CommonTree{TNode,TValue}"/>.</param>
        /// <returns>Smallest value in the <see cref="CommonTree{TNode,TValue}"/>.</returns>
        ...
        /// <see cref="CommonTree{TNode,TValue}"/>.
        /// </summary>
        /// <param name="value">Value of node to find parent of.</param>
        ...
        /// </summary>
        /// <param name="root">The root node of the <see cref="CommonTree{TNode,TValue}"/>.</param>
        /// <param name="item">The item to be located in the <see cref="CommonTree{TNode,TValue}"/>.</param>
        /// <returns>
        /// True if the item is contained within the <see cref="CommonTree{TNode,TValue}"/>; otherwise false.
        /// </returns>
